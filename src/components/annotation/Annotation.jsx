  ...
  return (
    <>
      <div
        ...
        className="absolute left-0 right-0 mx-auto w-fit bg-white flex flex-col justify-center p-6 shadow-lg gap-2 rounded-md border border-greyblue border-solid m-5"
      >
